    ...
    const client = new DaoshenRealtimeClient({
      ...
      onError: error => {
        ...
        const messages: Record<string, string> = {
          ...
          invalid_api_key: "API Key 无效或已过期，请更新 Key。",
          permission_denied: "API Key 权限不足，请检查 Key 配置。",
          rate_limit_or_quota: "请求过于频繁或额度不足，请稍后再试。",
          invalid_model: error.message || "Realtime 模型不可用，请检查模型配置。",
          invalid_realtime_request: error.message || "Realtime 请求参数错误，请联系开发者。",
          openai_unavailable: "OpenAI 服务暂时不可用，请稍后再试。",
